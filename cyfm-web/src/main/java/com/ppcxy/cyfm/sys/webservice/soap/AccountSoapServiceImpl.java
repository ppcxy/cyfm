 ...
 *******************************************************************************/
package com.ppcxy.cyfm.sys.webservice.soap;
...
import com.ppcxy.cyfm.sys.webservice.soap.response.base.IdResult;
...
import com.ppcxy.cyfm.sys.webservice.soap.response.GetTeamDetailResult;
import com.ppcxy.cyfm.sys.webservice.soap.response.GetUserResult;
import com.ppcxy.cyfm.sys.webservice.soap.response.SearchUserResult;
...
@WebService(serviceName = "AccountService", endpointInterface = "com.ppcxy.cyfm.sys.webservice.soap.AccountSoapService", targetNamespace = WsConstants.NS)
