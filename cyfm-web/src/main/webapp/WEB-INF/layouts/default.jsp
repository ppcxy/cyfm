...
<link href="${ctx}/static/plugins/bootstrap2/2.3.2/css/bootstrap.min.css" type="text/css" rel="stylesheet" />
...
<body>
	...
	<script src="${ctx}/static/plugins/bootstrap2/2.3.2/js/bootstrap.min.js" type="text/javascript"></script>
</body>
</html>
