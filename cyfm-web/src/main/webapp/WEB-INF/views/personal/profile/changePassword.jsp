                ...
                <form id="inputForm" method="post" action="#">
                    <div class="form-body">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="password" id="newPassword1" name="newPassword1" class="form-control validate[required,custom[includeSpace],minSize[5],maxSize[25]]" minlength="5" maxlength="25" placeholder="请输入5-25位的新密码"/>
                            </div>
                        </div>
                        <div class="control-group">
