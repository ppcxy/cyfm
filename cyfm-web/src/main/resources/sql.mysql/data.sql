...
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (20, '系统管理', 'fa fa-cogs', '', 1, '01/', '', 1, true, 0);
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (21, '用户管理', 'fa fa-user', 'user', 20, '01/20/', '/sys/user', 1, true, 0);
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (22, '团队管理', 'fa fa-users', 'team', 20, '01/20/', '/sys/team', 2, true, 0);
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (23, '角色管理', 'ztree_file', 'role', 20, '01/20/', '/sys/role', 3, true, 0);
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (24, '资源管理', 'icon-refresh', 'resource', 20, '01/20/', '/sys/resource', 4, true, 0);


INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (30, '系统监控', 'fa fa-cogs', '', 1, '01/', '', 2, true, 0);
...
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (40, '系统维护', 'ztree_file', '', 1, '01/', '', 3, true, 0);
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (41, '静态资源管理', 'ztree_file', '', 40, '01/40/', '/manage/maintain/staticResource', 1, true, 0);

INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (50, '演示功能', 'ztree_file', '', 1, '01/', '', 4, true, 0);
INSERT INTO cy_sys_resource (ID, NAME, ICON, IDENTITY, PARENT_ID, PARENT_IDS, URL, WEIGHT, IS_SHOW, RESOURCE_TYPE) VALUES (51, 'dialog演示', 'ztree_file', '', 50, '01/50/', '/demo/ui/dialog', 1, true, 0);
