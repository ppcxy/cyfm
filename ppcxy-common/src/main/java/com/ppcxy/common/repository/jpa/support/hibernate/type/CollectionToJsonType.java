 ...
 */
public class CollectionToJsonType implements UserType, ParameterizedType, Serializable {
    ...
    public void setParameterValues(Properties parameters) {
        ...
        this.javaType = jsonMapper.buildCollectionType(this.collectionType, this.elementType);
    }
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        return JsonMapper.defaultMapper().fromJson(valueStr, javaType);
    }
