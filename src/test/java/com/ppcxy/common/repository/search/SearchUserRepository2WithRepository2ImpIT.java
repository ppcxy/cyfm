...
import com.ppcxy.common.repository.UserRepository2;
...
public class SearchUserRepository2WithRepository2ImpIT extends BaseUserIT {
    ...
    public void testEqForEnum() {
        ...
        Assert.assertEquals(count, userRepository2.count(search));
    }
    ...
    public void testNotEqForEnum() {
        ...
        Searchable search = Searchable.newSearchable(searchParams);
        Assert.assertEquals(0, userRepository2.count(search));
    }
    ...
    public void testInWithSingleValue() throws ParseException {
        ...
        Searchable search = Searchable.newSearchable(searchParams);
        Assert.assertEquals(1, userRepository2.count(search));
    }
    ...
    public void testOr() {
        ...
        Assert.assertEquals(2, userRepository2.count(search));
    }
    ...
    public void testAndOr() {
        ...
        Assert.assertEquals(6, userRepository2.count(search));
    }
